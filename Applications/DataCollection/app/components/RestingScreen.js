...
export default class RestingScreen extends Component{
...
stopCounting = () =>{
  ...
  sensor.sendMessures("rest",randomNumber, ()=>
      ...
      return (
        <ImageBackground  style={{flex: 1,alignItems: 'center',justifyContent: 'center'}}>
          <View style={{ flex: 1, alignItems: 'center', justifyContent: 'center'}}>
            ...
            <Text style= {{fontWeight: 'bold', fontSize:30, width: width, textAlign: 'center', marginBottom: 10}}>Resting activity</Text>
            <Text style= {{fontWeight: 'bold', fontSize:20, width: width, textAlign: 'center', marginBottom: 10}}>
              Put your device on the table and 
            </Text>
            <Text style= {{fontWeight: 'bold', fontSize:20, width: width, textAlign: 'center', marginBottom: 10}}>
