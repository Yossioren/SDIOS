...
componentWillUnmount() {
  ...
  stopCounting = () =>{
    ...
    sensor.sendMessures("running",randomNumber, ()=>
      ...
      render() {
        ...
        return (
          <ImageBackground  style={{flex: 1,alignItems: 'center',justifyContent: 'center'}}>
            ...
            <Text style= {{fontWeight: 'bold', fontSize:30, width: width, textAlign: 'center', marginBottom: 10}}>Stairs activity</Text>
            <Text style= {{fontWeight: 'bold', fontSize:20, width: width, textAlign: 'center', marginBottom: 10}}>
            Hold your phone and start climbing or
            </Text>
            <Text style= {{fontWeight: 'bold', fontSize:20, width: width, textAlign: 'center', marginBottom: 10}}>
            get down the stairs until the time runs out.
            </Text>
            </View>
            </View>
