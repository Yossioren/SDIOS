...
componentWillUnmount() {
  ...
  stopCounting = () =>{
    ...
    sensor.sendMessures("walking",randomNumber, ()=>
     this.setState({nextTaskButton: false}));
  }
  
  onPressNextScreen(){
    this.props.navigation.navigate('Shaking', {
      ...
      render() {
        ...
        return (
          <ImageBackground  style={{flex: 1,alignItems: 'center',justifyContent: 'center'}}>
            ...
            <Text style= {{fontWeight: 'bold', fontSize:30, width: width, textAlign: 'center', marginBottom: 10}}>Walking activity</Text>
            <Text style= {{fontWeight: 'bold', fontSize:20, width: width, textAlign: 'center', marginBottom: 10}}>
            Hold your device in your hand and start
            </Text>
            <Text style= {{fontWeight: 'bold', fontSize:20, width: width, textAlign: 'center', marginBottom: 10}}>
             walking in the room until the time runs out 
            </Text>
            </View>
            </View>
