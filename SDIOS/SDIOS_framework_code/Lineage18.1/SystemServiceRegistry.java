 ...
 */
 ...
 public final class SystemServiceRegistry {
     ...
     static {
         ...
         registerService(Context.SENSOR_RAW_SERVICE, SensorManager.class,
        ...
        // SystemSensorManagerSdios comes after to overwrite the map entry of SensorManager.class
        registerService(Context.SENSOR_SERVICE, SensorManager.class,
                new CachedServiceFetcher<SensorManager>() {
            @Override
            public SensorManager createService(ContextImpl ctx) {
                return new SystemSensorManagerSdios(ctx.getOuterContext(),
                        ctx.mMainThread.getHandler().getLooper());
            }});
